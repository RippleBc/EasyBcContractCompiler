program helloworld;
	...
	procedure mixedArgFunc(x:integer;y:text;z:char);
		var inta: integer;
	begin
		inta := 1;
		if(inta != 1) then
	...
	// procedure testFunc(x,y:integer);
	// 	var
	// 		k,sum : integer;
	// begin
	// 	sum := 1;
	...
	// procedure testRecurveFunc(x:integer);
	// begin
	// 	if(x > 0) then
	// 	begin
	// 		arraya[x] := x;
	...
	// procedure insideFunc(x,y:integer);
	// 	var inta,intb : integer;
	// begin
